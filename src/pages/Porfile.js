...
const Porfile = () => {
  ...
  return (
    <div className={`font-sans antialiased leading-normal tracking-wider bg-cover background ${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'}`}>
      <div className="max-w-4xl flex justify-center items-center h-screen lg:h-screen flex-wrap mx-auto pt-20 lg:pt-0">
        <div id="profile" className={`w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl ${isDarkMode ? 'bg-gray-700-700' : 'bg-white'} opacity-75 mx-6 lg:mx-0`}>
          <div className="p-5 md:p-10 text-center lg:text-left">
            ...
            <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
              <svg className="h-4 fill-current text-blue-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"/></svg> FullStack developer
            </p>
            <p className={`pt-2 text-s lg:text-base flex items-center justify-center lg:justify-start ${isDarkMode ? 'text-white' : 'text-gray-600'}`}>
            ...
            <p className="pt-8 text-lg text-justify">FullStack & iOS developer | GDG Organizer | Lead at DSC UTP | CEO at Edomo.</p>
            <div className="pt-8 pb-4">
              <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full">
                <a href="https://codeon2024.vercel.app/" target="_blank" rel="noopener noreferrer">Registrarse al evento</a>
              </button>
            </div>
            <div className="mt-4 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-s justify-around">
              <a className="link" href="https://www.instagram.com/cristiandaos" target="_blank" rel="noopener noreferrer" data-tippy-content="@cristiandaos">
